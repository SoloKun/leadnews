...
public class ArticleUpOrDownListener {
    ...
    public void newsUpHandler(@Payload String articleId, Message message, Channel channel) {
    ...
    public void newsDownHandler(@Payload String articleId, Message message, Channel channel) {
