...
/**
 * ClassName: ReptilesDemo
 * Package: com.heima.wemedia
 * Description:
 *
 * @Author solokun
 * @Create 2023/6/28 22:04
 * @Version 1.0
 */
...
public class ReptilesDemo {
    ...
    public void initDriver(){
        System.setProperty("webdriver.chrome.driver", "D:\\QMDownload\\chromedriver_win32\\chromedriver.exe");
        WebDriver driver = new ChromeDriver();
        driver.get("https://m.163.com/touch/ent");
    ...
    public void reptilesData() throws IOException {
        ...
        for (Element liElement : liElements) {
            ...
            // 封装WmNewsDto对象
            WmNewsDTO submitWmNewsDTO = new WmNewsDTO();
            // 解析单个文章详情
            ...
            submitWmNewsDTO.setChannelId(6); // 设置频道
            try {
